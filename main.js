...
function check_sketch(){
  ...
  if (seconds=400) {
    seconds=0;
    seconds_check="completed";
  }
  if (seconds_check=="completed" || answer_holder=="set" ) {
        seconds_check=0;
        answer_holder="";
        updateCanvas();
  }
